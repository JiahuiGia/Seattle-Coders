...
if __name__ == '__main__':
    ...
    assert FR.find_root_dict() == 'being'
    assert FR.find_root_set() == 'being'

    FL = FindLeaves(LIST_OF_EDGES)
    assert FL.find_leaves_dict() == set(LEAVES)
    assert FL.find_leaves_set() == set(LEAVES)
